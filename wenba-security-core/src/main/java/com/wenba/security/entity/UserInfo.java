package com.wenba.security.entity;
...
public class UserInfo implements UserDetails,Serializable{
    ...
    /**
        ...
        public static class UserBuilder {
             ...
             * @return the {@link UserInfo.UserBuilder} for method chaining (i.e. to populate
            ...
            public UserDetails build() {
                ...
                return new UserInfo(username, encodedPassword, !disabled, !accountExpired,
